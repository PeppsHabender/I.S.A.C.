package org.inquest.analysis.model

import io.quarkus.mongodb.panache.common.MongoEntity
import org.bson.codecs.pojo.annotations.BsonCreator
import org.bson.codecs.pojo.annotations.BsonIgnore
import org.bson.codecs.pojo.annotations.BsonProperty
import org.inquest.shared.numbers.IntExtensions.averageOrNull
...
data class PlayerPull @BsonCreator constructor(
    ...
    @BsonIgnore
    val participated: Boolean = this.profession.name != "*"
}
...
class PlayerAnalysis @BsonCreator constructor(
    ...
    fun avgDps() = this.pulls.values.participated().map { it.dps }.average()
    ...
    fun avgBarrier() = this.pulls.values.participated().map { it.barrier }.average()
    ...
    private fun Iterable<PlayerPull>.participated() = filter { it.participated }
}
