...
import org.inquest.discord.isac.embed.ErrorEmbeds.CHANNEL_CONFIG_EXC_MSG
...
import org.inquest.discord.support.optionAsOptions
...
/**
 * Command 'save-config' which lets users provide a default config when using [org.inquest.discord.isac.embed.IsacCommand] in a channel.
 *
 * Options:
 * - [CommonOptions]
 */
